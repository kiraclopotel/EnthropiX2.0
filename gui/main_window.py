...
class MainWindow(tk.Tk):
    ...
    def setup_ui(self):
        ...
        self.decryption_tab = DecryptionTab(self.notebook, self.shared_state)  # Add DecryptionTab here
        ...
        self.notebook.add(self.decryption_tab, text="Decryption")  # Position Decryption next to Encryption
    ...
    def clear_all(self):
        ...
        self.decryption_tab.clear()  # Clear decryption tab if implemented with a clear function
    ...
    def show_docs(self):
        ...
        messagebox.showinfo("Documentation", 
            "Please visit https://docs.example.com for complete documentation")
